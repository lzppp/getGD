...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    serviceStop.write(request.getParameter("stopid").toString(),
    		request.getParameter("pathid").toString(),
    		request.getParameter("name").toString(),
    		request.getParameter("lng").toString(),
    		request.getParameter("lat").toString(),
    		request.getParameter("seq").toString());
